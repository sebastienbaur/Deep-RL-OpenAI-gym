...
Dueling DDQN on OpenAI's MountainCar problem
...
from dddqn_mountaincar.per import PrioritizedReplayBuffer
from dddqn_mountaincar.utils import DQN, update_eval_network, build_target, huber, update_reward, tensorboard
from dddqn_mountaincar.utils import create_exp_dir
...
dqn = DQN(hdim=100, adv_type='mean')
